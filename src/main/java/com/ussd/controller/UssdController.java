...
import com.ussd.api.BasicAuthConfiguration;
import com.ussd.api.SMSTextualRequest;
import com.ussd.api.SendSingleTextualSms;
import com.ussd.endrequest.EndRequest;
import com.ussd.endresponse.EndResponse;
import com.ussd.generatepin.Pin;
import com.ussd.login.ApiLogin;
import com.ussd.model.Employee;
import com.ussd.model.SMSResponse;
import com.ussd.propertyreader.PropertyReader;
import com.ussd.repository.EmployeeRepository;
import com.ussd.request.Request;
import com.ussd.response.Response;
import com.ussd.util.EmailService;
import com.ussd.util.Mail;
             ...
             if(response.getUssdMenu().equalsIgnoreCase(propertyReader.readProperty("welcome.page"))) {
                 ...
                 if(request.getText()!=null){
                     ...
                     if(employee!=null){
                         ...
                         com.ussd.api.SMSResponse smsResponse = client.execute(requestBody);
                         if(smsResponse!=null){
                             Response login = new Response(Boolean.FALSE,propertyReader.readProperty("login.page"),200,"");
                             responseMap.replace(request.getMsisdn(), login);
                             response = responseMap.get(request.getMsisdn());
